...
export class NgforComponent implements OnInit {
  ...
  onCreateUser(data:any){
    ...
    if(this.users.length > 3)//this will navigate/redirect to products page if no of users exceed a specific limit
    {
      alert("More than 3");//"aleart()" pops up a mini web page...
    }
  }
  onRemoveUser()
  {
